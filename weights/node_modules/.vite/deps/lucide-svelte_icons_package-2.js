...
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(22:0) <Icon name=\\"package-2\\" {...$$props} iconNode={iconNode}>',
    ctx
  });
  return block;
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("Package_2", slots, ["default"]);
  const iconNode = [
    [
      "path",
      {
...
var Package_2 = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
...
lucide-svelte/dist/icons/package-2.svelte:
   ...
   *)
*/
//# sourceMappingURL=lucide-svelte_icons_package-2.js.map
