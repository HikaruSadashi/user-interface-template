...
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(22:0) <Icon name=\\"circle-user\\" {...$$props} iconNode={iconNode}>',
    ctx
  });
  return block;
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("Circle_user", slots, ["default"]);
  const iconNode = [
...
var Circle_user = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
...
lucide-svelte/dist/icons/circle-user.svelte:
   ...
   *)
*/
//# sourceMappingURL=lucide-svelte_icons_circle-user.js.map
